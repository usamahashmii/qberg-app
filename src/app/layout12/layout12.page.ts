...
@Component({
  ...
  templateUrl: './layout12.page.html',
  styleUrls: ['./layout12.page.scss'],
})
export class Layout12Page implements OnInit {
  economyNewsArray: any;
  ...
  ngOnInit() {
    ...
    this.dataService.qPressCheckTabObservable().subscribe(data => {
      // console.log(data);
      if(data.layouts == 'layout3' && !this.apiResponse){
        console.log(data);
